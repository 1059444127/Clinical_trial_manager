...
<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
	...
	<ul class="list-unstyled user_data">
		...
		<?php if(get_user_meta($user->ID,'gender',true) == 'Male'): ?>
		<li><i class="fa fa-male"></i> Male</li>
		<?php elseif(get_user_meta($user->ID,'gender',true) == 'Female'): ?>
		<li><i class="fa fa-female"></i> Female</li>
		<?php endif; ?>
		<?php if(get_user_meta($uid,'user_phone',true) != ''): ?>
		<li><i class="fa fa-phone"></i> <?php echo get_user_meta($uid,'user_phone',true);?></li>
		<?php endif; ?>
		<li class="m-top-xs">
